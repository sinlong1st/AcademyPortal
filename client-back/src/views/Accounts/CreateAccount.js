...
class CreateAccount extends Component {
  ...
  hideAlertSuccess(){
    if(this.state.role==='student')
      this.props.history.push('/student-accounts')
    else
                ...
                <CardBody className="p-4">
                  <Form onSubmit={this.onSubmit}>
                    ...
                    <Container>
                      ...
                      <FormGroup check inline>
                        <Input className="form-check-input" type="radio" id="inline-radio5" name="role" value="student" onChange={this.onChange}/>
                        <Label className="form-check-label" check htmlFor="inline-radio5">Học viên</Label>
                      </FormGroup>
                    </Container>
