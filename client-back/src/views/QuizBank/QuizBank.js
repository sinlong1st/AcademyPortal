                  ...
                  <div style={{marginTop:20}}>
                    ...
                    <Table style={{marginTop:10}} hover responsive bordered className="table-outline mb-0 d-none d-sm-table" >
                      ...
                      <tbody>
                        {
                          currentlist.map(cat=>
                            <tr key={cat._id} className="changeCursor" onClick={()=>this.props.history.push(`/quiz-bank/${cat._id}`)}>
                              <td>
                                {cat.category}
                              </td>
                              <td>
...
export default connect(mapStateToProps, mapDispatchToProps)(QuizBank);
