...
class ChangeCourse extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.courses) {
      ...
      this.setState({
        allcourses: allcourses.filter(course => course._id !== this.props.match.params.courseId && Number(course.students.length) !== Number(course.maxStudent)),
        loading
      })
    }
                    ...
                    <tbody>
                      {
                        allcourses.map(course=>
                          <tr key={course._id}>
                            ...
                            <td>
                              <Button onClick={()=>this.props.history.push(`/choose-option/${this.props.match.params.userId}/${this.props.match.params.courseId}/change-course/${course._id}`)} className="btn-pill" color="secondary">
                                <b>Xem chi tiết</b>
                              </Button>
                            </td>
                            <td>
